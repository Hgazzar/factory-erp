...
final class ChartOfAccountsProvisioner
{
    ...
    public static function definitions(): Collection
    {
        ...
        return collect([
            ...
            ['code' => '1010', 'parent_code' => '1000', 'name_ar' => 'صندوق النقدية', 'name_en' => 'Cash on Hand', 'type' => $a, 'opening_balance' => 0],
            ['code' => '1020', 'parent_code' => '1000', 'name_ar' => 'البنك - الحساب الرئيسي', 'name_en' => 'Bank - Main Account', 'type' => $a, 'opening_balance' => 0, 'is_bank' => true],
            ['code' => '1030', 'parent_code' => '1000', 'name_ar' => 'الذمم المدينة', 'name_en' => 'Accounts Receivable', 'type' => $a, 'opening_balance' => 0],
            ...
            ['code' => '1040', 'parent_code' => '1000', 'name_ar' => 'المخزون', 'name_en' => 'Inventory', 'type' => $a, 'opening_balance' => 0],
            ...
            ['code' => '1510', 'parent_code' => '1500', 'name_ar' => 'مجمع الإهلاك', 'name_en' => 'Accumulated Depreciation', 'type' => $a, 'opening_balance' => 0],
            ['code' => '2000', 'parent_code' => null, 'name_ar' => 'الخصوم المتداولة', 'name_en' => 'Current Liabilities', 'type' => $l, 'opening_balance' => 0],
            ['code' => '2010', 'parent_code' => '2000', 'name_ar' => 'الذمم الدائنة', 'name_en' => 'Accounts Payable', 'type' => $l, 'opening_balance' => 0],
            ['code' => '2030', 'parent_code' => '2000', 'name_ar' => 'ضريبة القيمة المضافة المستحقة', 'name_en' => 'VAT Payable', 'type' => $l, 'opening_balance' => 0],
            ['code' => '2020', 'parent_code' => '2000', 'name_ar' => 'قروض قصيرة الأجل', 'name_en' => 'Short-term Loans', 'type' => $l, 'opening_balance' => 0],
            ['code' => '3000', 'parent_code' => null, 'name_ar' => 'حقوق الملكية', 'name_en' => 'Owner\'s Equity', 'type' => $l, 'opening_balance' => 0],
