...
@section('title', 'مستودع جديد - '.config('app.name'))
...
@section('breadcrumb')
    ...
    <span>›</span>
    <span class="text-indigo-900 font-semibold">إضافة مستودع</span>
@endsection
...
<div dir="rtl" class="content-wrap">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h4 mb-1">مستودع جديد</h1>
            <p class="text-muted mb-0 small">تسجيل بيانات المستودع وفق الهوية الموحدة للنظام</p>
        </div>
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name_ar" class="form-control @error('name_ar') is-invalid @enderror" value="{{ old('name_ar') }}" required placeholder="أدخل اسم المستودع">
                        @error('name_ar')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">الرمز <span class="text-danger">*</span> <x-info field="inventory.wh_form_code" /></label>
                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" required maxlength="30" placeholder="مثلاً: WH-001">
                        @error('code')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">الاسم بالإنجليزية <x-info field="inventory.wh_form_name_en" /></label>
                        <input type="text" name="name_en" class="form-control" value="{{ old('name_en') }}" placeholder="Warehouse name">
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="d-flex align-items-center pt-2">
                            ...
                            <label class="form-check-label ms-2" for="is_active">نشط — المستودع يمكنه استقبال المخزون</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" value="{{ old('address') }}" placeholder="أدخل عنوان المستودع">
                        @error('address')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">المسؤول عن المستودع <x-info field="inventory.wh_form_manager" /></label>
                        <input type="text" name="manager" class="form-control" value="{{ old('manager') }}" placeholder="اسم المسؤول">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="map_location" class="form-control" value="{{ old('map_location') }}" placeholder="رابط خرائط أو وصف الموقع">
                    </div>
                    <div class="col-12">
                        <label class="form-label">الوصف <x-info field="inventory.wh_form_description" /></label>
                        <textarea name="description" class="form-control" rows="2" placeholder="ملاحظات">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
