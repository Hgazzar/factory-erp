...
<div class="space-y-3"
    ...
    <div class="flex flex-wrap items-center justify-between gap-2">
        ...
        <button type="button" @click="addMed()"
                class="text-sm font-semibold text-orange-600 hover:text-orange-800">+ إضافة دواء</button>
    </div>

    <p x-show="meds.length === 0" x-cloak
       class="text-sm text-orange-700/70 rounded-lg border border-dashed border-orange-200 bg-orange-50/30 px-3 py-2.5">
        لا توجد أدوية مسجّلة. اضغط «+ إضافة دواء» عند الحاجة فقط.
    </p>

    <template x-for="(med, index) in meds" :key="index">
        <div class="p-4 rounded-lg border border-orange-100 bg-orange-50/40 space-y-3">
            <div class="flex justify-between items-center">
                <span class="text-sm font-bold text-orange-950">دواء <span x-text="index + 1"></span></span>
            ...
            <div class="grid gap-3 sm:grid-cols-2">
                ...
                <div>
                    <label class="block text-sm font-semibold text-orange-950 mb-1 mb-2">
                        التكرار
