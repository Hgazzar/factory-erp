    ...
    <div class="grid gap-5 xl:grid-cols-[1fr_minmax(280px,360px)]">
        <div class="space-y-5">
            <section class="nursery-card p-5 space-y-4">
                <h2 class="text-lg font-bold text-teal-950 border-b border-teal-100 pb-2">بيانات الموظف</h2>
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">الاسم الأول <span class="text-red-600">*</span> <x-info field="nursery.staff_first_name" /></label>
                        <input type="text" name="first_name" value="{{ old('first_name', $employee?->first_name) }}" required class="w-full rounded-lg border border-teal-200 px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">اسم العائلة <span class="text-red-600">*</span> <x-info field="nursery.staff_last_name" /></label>
                        <input type="text" name="last_name" value="{{ old('last_name', $employee?->last_name) }}" required class="w-full rounded-lg border border-teal-200 px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">رقم الهوية <x-info field="nursery.staff_id_number" /></label>
                        <input type="text" name="id_number" value="{{ old('id_number', $employee?->id_number) }}" class="w-full rounded-lg border border-teal-200 px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">الجنس <x-info field="nursery.staff_gender" /></label>
                        <x-custom-select name="gender" :options="$genderOptions" :value="old('gender', $employee?->gender)" :searchable="false" empty-label="—" />
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">تاريخ الميلاد <x-info field="nursery.staff_birth_date" /></label>
                        <input type="date" name="birth_date" value="{{ old('birth_date', $employee?->birth_date?->format('Y-m-d')) }}" class="w-full rounded-lg border border-teal-200 px-3 py-2">
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">مناوبة الحضانة <x-info field="nursery.staff_nursery_shift" /></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">المؤهل <x-info field="nursery.staff_education" /></label>
                        <input type="text" name="nursery_education" value="{{ old('nursery_education', $employee?->nursery_education) }}" class="w-full rounded-lg border border-teal-200 px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">التخصص <x-info field="nursery.staff_specialization" /></label>
                        <input type="text" name="nursery_specialization" value="{{ old('nursery_specialization', $employee?->nursery_specialization) }}" class="w-full rounded-lg border border-teal-200 px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">رقم الجوال <span class="text-red-600">*</span> <x-info field="nursery.staff_mobile" /></label>
                        <input type="text" name="mobile" value="{{ old('mobile', $employee?->mobile ?? $employee?->phone) }}" required class="w-full rounded-lg border border-teal-200 px-3 py-2" dir="ltr">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">البريد الإلكتروني <span class="text-red-600">*</span> <x-info field="nursery.staff_email" /></label>
                        <input type="email" name="email" value="{{ old('email', $employee?->email) }}" required class="w-full rounded-lg border border-teal-200 px-3 py-2" dir="ltr">
                    </div>
                    <div class="sm:col-span-2">
                        <label class="block text-sm font-semibold text-teal-950 mb-1">العنوان <x-info field="nursery.staff_address" /></label>
                        <input type="text" name="address" value="{{ old('address', $employee?->address) }}" class="w-full rounded-lg border border-teal-200 px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">المنطقة <x-info field="nursery.staff_region" /></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-teal-950 mb-1">دور التشغيل <x-info field="nursery.employee_nursery_role" /></label>
            ...
            <section class="nursery-card p-5 space-y-4">
                ...
                @endif
                <div>
                    <label class="block text-sm font-semibold text-teal-950 mb-1">رفع ملفات <x-info field="nursery.staff_attachments_upload" /></label>
                    <input type="file" name="attachments[]" multiple accept=".jpg,.jpeg,.png,.gif,.webp,.pdf,.doc,.docx,.xls,.xlsx,.txt"
                           class="w-full rounded-lg border border-teal-200 px-3 py-2 text-sm bg-white">
                </div>
            </section>
        </div>
