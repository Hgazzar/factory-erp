        ...
        <section class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="space-y-1 md:col-span-2">
                    ...
                    <input id="opening_balance" name="opening_balance" type="number" inputmode="decimal" step="any" value="{{ old('opening_balance', $account->opening_balance) }}" class="h-11 w-full rounded-lg border border-gray-200 bg-gray-50 px-3 text-sm focus:border-blue-500 focus:ring-blue-500">
