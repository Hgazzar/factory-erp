...
@section('title', 'إضافة حساب بنكي - MIRADA ERP')
...
@section('breadcrumb')
    ...
    <span class="mx-1 text-gray-400">›</span>
    <span class="text-blue-900 font-semibold">إضافة حساب بنكي</span>
@endsection
...
<div dir="rtl" class="mx-auto w-full max-w-full space-y-6">
    ...
    <form method="POST" action="{{ route('finance.bank-accounts.store') }}" class="space-y-6">
        @csrf
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div class="space-y-1">
                    ...
                    <input id="bank_name" name="bank_name" type="text" value="{{ old('bank_name') }}" class="h-11 w-full rounded-lg border border-gray-200 bg-gray-50 px-3 text-sm focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="space-y-1">
                    ...
                    <input id="branch_name" name="branch_name" type="text" value="{{ old('branch_name') }}" class="h-11 w-full rounded-lg border border-gray-200 bg-gray-50 px-3 text-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
                <div class="space-y-1">
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div class="space-y-1">
                    ...
                    <input id="account_number" name="account_number" type="text" value="{{ old('account_number') }}" class="h-11 w-full rounded-lg border border-gray-200 bg-gray-50 px-3 text-sm focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="space-y-1">
                    ...
                    <input id="iban" name="iban" type="text" value="{{ old('iban') }}" placeholder="SA..." class="h-11 w-full rounded-lg border border-gray-200 bg-gray-50 px-3 text-sm uppercase focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="space-y-1">
                    ...
                    <select id="currency" name="currency" class="h-11 w-full rounded-lg border border-gray-200 bg-gray-50 px-3 text-sm focus:border-blue-500 focus:ring-blue-500">
                        <option value="SAR" @selected(old('currency', 'SAR') === 'SAR')>SAR</option>
                        <option value="USD" @selected(old('currency') === 'USD')>USD</option>
                        <option value="EUR" @selected(old('currency') === 'EUR')>EUR</option>
                        <option value="AED" @selected(old('currency') === 'AED')>AED</option>
            ...
            <div class="space-y-3">
                <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-3">
                    ...
                    <label class="cc-switch" aria-label="تفعيل الحساب البنكي">
                        ...
                        <input type="checkbox" name="status" value="active" class="cc-switch-input" @checked(old('status', 'active') === 'active')>
