...
@section('title', 'تعديل فئة أصل - '.config('app.name'))
...
<div dir="rtl" class="mx-auto w-full max-w-4xl space-y-6">
    <header class="flex flex-wrap items-center justify-between gap-4">
        <h1 class="text-2xl font-bold text-gray-900">تعديل فئة: {{ $category->name_ar }}</h1>
    ...
    <form method="POST" action="{{ route('finance.fixed-assets.categories.update', $category) }}" class="space-y-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        @csrf
        @method('PUT')
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div class="md:col-span-2">
                ...
                <x-searchable-select
                    ...
                    :options="$assetOpts"
                    :value="old('ledger_asset_account_id', $category->ledger_asset_account_id)"
                    :required="true"
            ...
            <div class="md:col-span-2">
                ...
                <x-searchable-select
                    ...
                    :options="$expenseOpts"
                    :value="old('ledger_depreciation_cost_account_id', $category->ledger_depreciation_cost_account_id)"
                    :required="true"
            ...
            <div class="md:col-span-2">
                ...
                <x-searchable-select
                    ...
                    :options="$assetOpts"
                    :value="old('ledger_accumulated_depreciation_account_id', $category->ledger_accumulated_depreciation_account_id)"
                    :required="true"
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit" class="rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-700">حفظ التعديلات</button>
        </div>
    </form>
</div>
@endsection
