...
@section('title', 'تعديل إشعار ائتمان - MIRADA ERP')
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="space-y-1">
                    ...
                    <select id="reason_type" name="reason_type" class="h-11 w-full rounded-lg border border-gray-200 bg-gray-50 px-3 text-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <option value="مرتجع مبيعات" @selected(old('reason_type', $creditNote->reason_type) === 'مرتجع مبيعات')>مرتجع مبيعات</option>
                        <option value="تسوية سعر" @selected(old('reason_type', $creditNote->reason_type) === 'تسوية سعر')>تسوية سعر</option>
                        <option value="خصم لاحق" @selected(old('reason_type', $creditNote->reason_type) === 'خصم لاحق')>خصم لاحق</option>
                        <option value="خطأ فاتورة" @selected(old('reason_type', $creditNote->reason_type) === 'خطأ فاتورة')>خطأ فاتورة</option>
                        <option value="أخرى" @selected(old('reason_type', $creditNote->reason_type) === 'أخرى')>أخرى</option>
                    </select>
