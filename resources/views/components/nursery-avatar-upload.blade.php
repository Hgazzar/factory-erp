    ...
    <div class="flex flex-wrap items-center gap-4">
        <div class="shrink-0 relative">
            ...
            <button type="button"
                    ...
                    x-cloak
                    @click="clearPreview()"
                    class="absolute -top-1 -start-1 inline-flex h-7 w-7 items-center justify-center rounded-full border border-orange-200 bg-white text-orange-800 shadow-sm hover:bg-red-50 hover:text-red-700 hover:border-red-200 focus:outline-none focus:ring-2 focus:ring-orange-400"
                    title="إلغاء الصورة"
        ...
        <div class="min-w-0 flex-1 space-y-2">
            ...
            <p class="text-xs text-orange-800/70">JPG أو PNG أو WebP — تظهر في القوائم والجداول بجانب الاسم. اضغط ✕ على الصورة لإلغائها.</p>
            <input type="file"
                   name="{{ $inputName }}"
                   x-ref="fileInput"
            ...
            @enderror
            <p class="text-xs text-orange-700/80" x-show="preview && pendingFile" x-cloak>تم اختيار صورة جديدة — احفظ النموذج لتأكيدها، أو اضغط ✕ للإلغاء.</p>
