                            ...
                            @foreach($existingRows as $att)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ asset('storage/'.ltrim($att->file_path, '/')) }}" target="_blank" rel="noopener noreferrer" class="small">فتح</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                            ...
                            @foreach($existingRows as $att)
                                <tr class="border-b border-gray-100 bg-white">
                                    ...
                                    <td class="px-3 py-2 text-center">
                                        <a href="{{ asset('storage/'.ltrim($att->file_path, '/')) }}" target="_blank" rel="noopener noreferrer" class="text-sm font-medium text-indigo-600 hover:text-indigo-800">فتح</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
