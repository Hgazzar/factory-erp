    ...
    <div class="mb-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        @else
            <x-attachment-handler
                ...
                :uploadable="false"
                :allow-delete="true"
                help-text="لإضافة مرفقات جديدة استخدم «معلق» ونموذج الحفظ أعلاه؛ يمكن إرفاق مستندات إضافية على قيد اليومية من شاشة تعديل القيد. الحذف متاح لكل المرفقات المعروضة."
            />
        @endif
    </div>
