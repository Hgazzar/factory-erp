...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | خطوط PDF العربية (Cairo)
    |--------------------------------------------------------------------------
    |
    | ملفات TTF لخط Cairo موجودة في resources/fonts/cairo/ وتُحمَّل عبر @font-face
    | في قوالب PDF (مثلاً pdf.partials.cairo-font-face). يجب أن يبقى المسار ضمن
    | مجلد المشروع لأن dompdf يقيّد القراءة بخيار chroot (جذر المشروع).
    | تُستخدَم DejaVu Sans كاحتياطي للأرقام والنص اللاتيني (مدمجة مع dompdf).
    |
    */
    ...
    */
    ...
    'options' => [
        ...
        /*
         * اتجاه RTL في PDF يُضبط عبر HTML/CSS (dir="rtl"، direction: rtl، وعكس ترتيب أعمدة
         * الجداول عند الحاجة)؛ dompdf لا يوفّر خياراً منفصلاً لـ RTL في هذا الملف.
         */
