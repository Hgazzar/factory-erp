...
return [
    ...
    */
    ...
    |---------------------------------------------------------------------------
    |
    | null = build script URLs from the app URL (APP_URL / request). Set only if
    | you must load Livewire JS from a fixed absolute URL (CDN). Prefer ASSET_URL
    | in .env for the whole app on Railway instead of setting this.
    |
    */
